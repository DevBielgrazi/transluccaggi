...
for($i=1;$i<=12;$i++){        
    $data[] = array($mes_rel[$i],saldo(frete($ano_rel."-".$i."-01",$ano_rel."-".$i."-31"),custo($ano_rel."-".$i."-01",$ano_rel."-".$i."-31")), frete($ano_rel."-".$i."-01",$ano_rel."-".$i."-31"),custo($ano_rel."-".$i."-01",$ano_rel."-".$i."-31"));
}
